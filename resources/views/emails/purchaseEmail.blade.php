                     ...
                     <td align="left" style="Margin:0;padding-bottom:15px;padding-top:30px;padding-left:30px;padding-right:30px;border-radius:10px 10px 0px 0px;background-color:#FFFFFF;" bgcolor="#ffffff">
                      ...
                      @foreach($products as $product)
                        ...
                        <tr style="border: 1px solid black; border-collapse:collapse">
                            ...
                            @else
                              <td style="border: 1px solid black; border-collapse:collapse; text-align:center">{{ $product["productFormatSize"]["product"]["english_name"] }} {{ number_format($product["productFormatSize"]["size"]["width"] / 2.54, 2, ".", ",") }}in / {{ number_format($product["productFormatSize"]["size"]["height"] / 2.54, 2, ".", ",") }}in </td>
                            @endif
