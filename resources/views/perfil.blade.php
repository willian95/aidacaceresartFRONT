            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input placeholder="pedro perez" type="email" autocomplete="off" class="form-control"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input placeholder="Dirección" type="password" class="form-control  " id="password">
                        <i class="fa fa-globe icon_form"></i>
                    </div>
                    <div class="form-group">
                        <label for="password">Telefono</label>

                        <input placeholder="+1234567" type="password" class="form-control  " id="password">
